...
❌  Не пытайтесь использовать этот проект пока видите это сообщение!
    ...
    Для удовлетворения интереса доступна промежуточная версия (частично работоспособная) в этой ветке
...
- Анализ ошибок для составных аудиоустройств

![Составное устройство с ошибкой](./readme_images/multi_devices.jpg)

### Унаследованная система аудио мониторинга

- **WebSocket аудио система** из оригинального проекта

- **Прослушивание RX аудио** прямо в браузере
...
## Техническая реализация аудио системы

### Компоненты системы (унаследовано из оригинала)
...
Аудио система использует ту же конфигурацию, что и оригинал
