...
![Версия](https://img.shields.io/badge/Version-0.1.6-red?style=flat)
![Лицензия](https://img.shields.io/badge/Licensy-GNU FDL v1.3-green?style=flat)
...
- New server-side architecture, rewritten from scratch

- WSPD-style user interface

- Informative status bar with connection information

- Reflectors, Talkgroups, Links
