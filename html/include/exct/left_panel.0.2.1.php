 ...
 * @version 0.2.1
 * @since 0.1.19
 * @filesource /include/fn/left_panel.0.2.1.php
 * @simlink /include/left_panel.php
    ...
    <div class="mode_flex row">
      <div class="mode_flex column">
        <div class="divTableCell white-space:normal">
          <div class="<?= $displayData['service']['style'] ?>">
            ...
            <div class="divTable">
              ...
              <div class="divTableBody">
                <div class="divTableRow center">
                  ...
                  <div class="divTableCell cell_content middle <?= $reflector['style'] ?>" style="border: .5px solid #3c3f47;">
                    <?= $reflector['name'] ?>
                  </div>
                </div>
...
unset(
  $displayData, $excl,
  $logic,
  $lp_status, $linkIndex, $linkCount, $link, 
  $nodeCount, $nodeIndex, $node, $reflector, 
  $tgIndex, $tgCount, $group,
  $moduleIndex, $moduleCount, $module
);
