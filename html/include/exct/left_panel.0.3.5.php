...
<?php if (!empty($displayData['logics'])):
	foreach ($displayData['logics'] as $logic): ?>
		...
		<div class="mode_flex">
			...
			<div id="<?= $logic['name'] ?>modulesTable" class="divTable <?= $nodesTableStyle ?>">
				<div id="<?= $logic['name'] ?>moduleNodesHeader" class="divTableHead"><?= $nodesTableHeader ?></div>
				<div class="divTableBody">
					<div class="mode_flex">
						<div class="mode_flex row">
							<div id="<?= $logic['name'] ?>moduleNodesContent" class="mode_flex column disabled-mode-cell" style="border: .5px solid #3c3f47;">
