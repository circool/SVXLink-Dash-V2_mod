...
//
// define("KEY1", array(' TG МОСКВА ','9177#','green'));
// define("KEY2", array(' TG Помощь ','91112#','green'));
// define("KEY3", array(' TG Общая ','91999#','green'));
// define("KEY4", array(' TG Отключиться ','910#','red'));
// define("KEY5", array(' EL Отключиться ','#','red'));
// define("KEY6", array(' EL *RUSSIA*', 'D3692#','purple'));
// define("KEY7", array(' EL *ANGARA* ','D3692#','purple'));
